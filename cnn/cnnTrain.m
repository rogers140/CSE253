...
filterDim = 5;    % Filter size for conv layer,9*9
numFilters = 1;   % Number of filters for conv layer
poolDim = 12;      % Pooling dimension, (should divide imageDim-filterDim+1)
